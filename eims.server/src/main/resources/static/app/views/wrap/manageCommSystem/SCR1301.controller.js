...
var SCR1301Controller = function () {
	...
	(0, _createClass3.default)(SCR1301Controller, [{
		...
		value: function initGrid() {
			...
			}, { field: 'sysCd', caption: this.text.sysCd, size: 1, sortable: true }, { field: 'sysNm', caption: this.text.sysNm, size: 1, sortable: true, attr: 'align=left' }, { field: 'sysCdDesc', caption: this.text.sysCdDesc, size: 3, attr: 'align=left' }];
