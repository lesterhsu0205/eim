	...
	(0, _createClass3.default)(SCR1101Controller, [{
		...
		value: function initGrid() {
			...
			this.options = {
				...
				}, { field: 'itemId', caption: this.text.itemId, size: '3%', sortable: true }, { field: 'itemDesc', caption: this.text.itemDesc, size: '3%', attr: 'align=left' }, { field: 'workDttm', caption: this.text.workDttm, size: '3%',
					render: function render(data) {
						return _this3.utilService.setRegDttm(data.workDttm);
					}
				}, { field: 'userId', caption: this.text.userId, size: '1%' }, { field: 'workCttCd', caption: this.text.workCttCd, size: '1%',
					render: function render(data, index, colIndex) {
