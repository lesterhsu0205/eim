	...
	(0, _createClass3.default)(SCR0901Controller, [{
		...
		value: function initGrid() {
			...
			this.inferfaceMainGrid = {
				...
				}, { field: 'sysCdS', caption: this.text.sysCdS, size: this.user.locale === 'en' ? '90px' : '0.5%', sortable: true }, { field: 'sysCdR', caption: this.text.sysCdR, size: this.user.locale === 'en' ? '95px' : '0.5%', sortable: true }, { field: 'instCd', caption: this.text.instCd, size: this.user.locale === 'en' ? '100px' : '0.5%', sortable: true }, {
