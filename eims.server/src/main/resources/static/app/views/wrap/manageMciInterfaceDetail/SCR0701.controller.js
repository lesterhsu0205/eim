	...
	(0, _createClass3.default)(SCR0701Controller2, [{
		...
		value: function initGrid() {
			...
			this.inferfaceMainGrid = {
				...
				columns: [{ field: 'intrfcId', caption: this.text.intrfcId, size: '1.5%', sortable: true }, { field: 'intrfcNm', caption: this.text.intrfcNm, size: '2.5%', sortable: true, attr: 'align=left' }, {
					field: 'lvCds', caption: this.text.lvCds, size: '0.7%', sortable: true,
					render: function render(data) {
						return data.lv1Cd ? data.lv1Cd : '';
					}
				}, { field: 'sysCdS', caption: this.text.sysCdS, size: '0.5%' }, { field: 'sysCdR', caption: this.text.sysCdR, size: '0.5%' }, { field: 'regManId', caption: this.text.regManId, size: '0.7%' }, {
