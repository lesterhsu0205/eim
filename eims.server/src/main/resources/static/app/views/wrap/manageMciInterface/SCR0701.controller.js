	...
	(0, _createClass3.default)(SCR0701Controller, [{
		...
		value: function initGrid() {
			...
			this.inferfaceMainGrid = {
				...
				}, { field: 'sysCdS', caption: this.text.sysCdS, size: '0.5%', sortable: true }, { field: 'sysCdR', caption: this.text.sysCdR, size: '0.5%', sortable: true }, { field: 'regManId', caption: this.text.regManId, size: '0.7%', sortable: true }, {
