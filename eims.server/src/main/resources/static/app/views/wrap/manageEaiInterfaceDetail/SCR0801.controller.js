		...
		value: function initGrid() {
			...
			this.inferfaceMainGrid = {
				...
				columns: [{ field: 'intrfcId', caption: this.text.intrfcId, size: '1.5%', sortable: true }, { field: 'intrfcNm', caption: this.text.intrfcNm, size: '2.5%', sortable: true, attr: 'align=left' }, {
					...
					field: 'intrfcWayCd', caption: this.text.trxTypeDscd, size: '0.7%',
					render: function render(data) {
						return _this5.codeService.getCodeValNm('INTRFC_WAY_CD', data.intrfcWayCd);
					}
				}, { field: 'sysCdS', caption: this.text.sysCdS, size: this.user.locale === 'en' ? '90px' : '0.5%' }, { field: 'sysCdR', caption: this.text.sysCdR, size: this.user.locale === 'en' ? '95px' : '0.5%' }, { field: 'regManId', caption: this.text.regManId, size: '0.7%' }, {
