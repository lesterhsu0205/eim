	...
	(0, _createClass3.default)(SCR0102Controller, [{
		...
		value: function initUserGridOption() {
			...
			this.userOptions = {
				...
				}, { field: 'userId', caption: this.text.userId }, { field: 'userNm', caption: this.text.userNm }, { field: 'deptNm', caption: this.text.deptNm }, { field: 'roleId', caption: this.text.roleId }],
