webpackJsonp(["app\\views\\popup\\SCR1803\\SCR1803.controller"],{
...
module.exports = __webpack_require__("45f167ac69ff5e73f3ae");


/***/ }),

/***/ "45f167ac69ff5e73f3ae":
/***/ (function(module, exports, __webpack_require__) {
...
var SCR1803Controller = function () {
	function SCR1803Controller($scope, $state, $uibModalInstance, httpService, utilService, gridService, popupService, data) {
		(0, _classCallCheck3.default)(this, SCR1803Controller);
	...
	(0, _createClass3.default)(SCR1803Controller, [{
		key: 'initWindow',
		...
		value: function initIntrfcGridOption() {
			...
			this.intrfcOptions = {
				...
				}, { field: 'intrfcId', caption: this.text.intrfcId, size: '3%' }, { field: 'intrfcNm', caption: this.text.intrfcNm, size: '3%' }, { field: 'intrfcType', caption: this.text.dataTypeNm, size: '1%' }, { field: 'msgLayoutId', caption: this.text.msgId, size: '2%' }, {
	...
	return SCR1803Controller;
}();

(0, _angular.module)(_app2.default.name).controller('SCR1803Controller', SCR1803Controller);

/***/ })

},[42]);
//# sourceMappingURL=SCR1803.controller.js.map