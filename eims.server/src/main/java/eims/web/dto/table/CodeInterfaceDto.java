...
public class CodeInterfaceDto {
	...
	public String getDmnLgclNm() {
		return dmnLgclNm;
	}
	public void setDmnLgclNm(String dmnLgclNm) {
		this.dmnLgclNm = dmnLgclNm;
	}
	public String getDmnPsclNm() {
		return dmnPsclNm;
	}
	public void setDmnPsclNm(String dmnPsclNm) {
		this.dmnPsclNm = dmnPsclNm;
	}
	public String getDmnCdVal() {
		return dmnCdVal;
	}
	public void setDmnCdVal(String dmnCdVal) {
		this.dmnCdVal = dmnCdVal;
	}
	public String getDmnCdValGlbl() {
		return dmnCdValGlbl;
	}
	public void setDmnCdValGlbl(String dmnCdValGlbl) {
		this.dmnCdValGlbl = dmnCdValGlbl;
	}
	public String getStdTrmDataScl() {
		return stdTrmDataScl;
	}
	public void setStdTrmDataScl(String stdTrmDataScl) {
