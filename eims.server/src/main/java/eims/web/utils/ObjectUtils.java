...
public class ObjectUtils {
	 ...
	 * @param element 확인할 구성요소
	 * @return 배열에 <code>element</code>가 있는지 여부
	 *         <code>array</code>가 <code>null</code>인 경우 <code>false</code> 리턴
	 */
	 ...
	 * 
	 * @param array 배열 객체 (can be <code>null</code>)
	 * @param obj 추가할 객체
	 ...
	 * 전달된 두 객체가 같은지 확인한다.
	 * 
	 * @param o1 대상 객체 (may be <code>null</code>,
	 *        in which case the return value will always be <code>false</code>)
	 * @param o2 비교 대상 객체
	 * @return whether the given objects are equal
	 */
