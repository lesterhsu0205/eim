webpackJsonp(["app\\views\\wrap\\manageFepInterfaceDetail\\SCR0901.controller"],{
...
module.exports = __webpack_require__("ee3890d7f73cf4d7ccf4");


/***/ }),

/***/ "ee3890d7f73cf4d7ccf4":
/***/ (function(module, exports, __webpack_require__) {
...
var SCR0901Controller2 = function () {
	function SCR0901Controller2($scope, $state, $compile, $timeout, popupService, httpService, utilService, gridService, codeService, metaService, userService, codes) {
		var _this = this;

		(0, _classCallCheck3.default)(this, SCR0901Controller2);
	...
	(0, _createClass3.default)(SCR0901Controller2, [{
		key: 'initPrevData',
		...
		value: function editIntrfcDetailGrid() {
			...
			}, { field: 'sysNm', caption: this.text.sysNm, size: '1.5%' }, { field: 'crgManNm', caption: '<i class="asterisk"></i>' + this.text.crgManNm, size: '1.5%', editable: { type: 'text' } }, { field: 'trxCd', caption: '<i class="asterisk"></i>' + this.text.trxCd, size: '1%', editable: { type: 'text' } }];
		...
		value: function setDefaultDeployTarget() {
			...
			this.httpService.post('/depolysyss/getlist', ['FEP', 'SIM', 'RSH', 'E2E']).then(function (data) {
		...
		value: function openMsgLayoutPopup() {
			...
			this.popupService.openModal('SCR0502').then(function (data) {
				return _this17.searchParam.intrfccoms.msgLayoutId = data.msgLayoutId;
			}).catch(function () {});
		}
	}, {
		key: 'openInstCdPopup',
		value: function openInstCdPopup() {
			...
			this.popupService.openModal('SCR1602').then(function (data) {
				_this18.detail.instCd = data.instCd;
				_this18.detail.instCdNm = data.instCdNm;
			}).catch(function () {});
		}
	}, {
		...
		value: function openInstCdPopup2() {
			...
			this.popupService.openModal('SCR1602').then(function (data) {
				return _this19.searchParam.intrfccoms.instCd = data.instCd;
			}).catch(function () {});
		}
	}, {
		key: 'openSystemPopup',
		value: function openSystemPopup(id) {
			...
			this.popupService.openModal('SCR1302').then(function (data) {
				if (id == 'snd') {
					_this20.searchParam.intrfccoms.sysCdS = data.sysCd;
				} else if (id == 'rcv') {
					_this20.searchParam.intrfccoms.sysCdR = data.sysCd;
				}
			}).catch(function () {});
		}
	}, {
		...
		value: function openRegManPopup() {
			...
			this.popupService.openModal('SCR0102').then(function (user) {
				return _this21.searchParam.intrfccoms.regManId = user.userId;
			}).catch(function () {});
		}
	}, {
		...
		value: function openInterfaceIdCreatePopup() {
			...
			this.popupService.openModal('SCR0702', { intrfcTypeCd: this.intrfcTypeCd }).then(function (intrfc) {
				...
				if (detail.trxDscd == 'ONLINE') {
					_this22.isOnline = true;
					_this22.isBatch = false;
				} else if (detail.trxDscd == 'BATCH') {
					_this22.isOnline = false;
					_this22.isBatch = true;
				}
		...
		value: function deployInterface(event) {
			...
			}, function () {}, bxMsg('common.confirmOk'), bxMsg('common.confirmCancel'));
		}
	}, {
		key: 'isRowMetaValid',
	...
	return SCR0901Controller2;
}();

(0, _angular.module)(_app2.default.name).controller('SCR0901Controller2', SCR0901Controller2);
